...
const TIMELINE_STEPS = [
  { key: 'created', label: 'Created', statuses: ['todo', 'assigned', 'in_progress', 'running', 'completed', 'failed', 'qa', 'deployed'] },
  { key: 'assigned', label: 'Assigned', statuses: ['assigned', 'in_progress', 'running', 'completed', 'failed', 'qa', 'deployed'] },
  { key: 'in_progress', label: 'Working', statuses: ['in_progress', 'running', 'completed', 'failed', 'qa', 'deployed'] },
...
function getStepTime(task, key) {
  ...
  if (key === 'completed') return task.completed_at;
