...
export default function App() {
  const {
    ...
    applyStatusChange,
    currentPage, totalPages, totalCount, goToPage,
  } = useQueue();
  ...
  const { progress: taskProgress, monitor: taskMonitor, connected: sseConnected } = useTaskEvents({ onStatusChange: applyStatusChange });
